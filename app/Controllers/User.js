									...
									try {
										UserInfo.create({'id':client.UID, 'name':name, 'red':0, 'joinedOn':new Date()}, function(errC, user){
											if (!!errC) {
												...
												LongLan_user.create({'uidss': client.UID});
											//	ThuongHai_user.create({'uid': client.UID});
												...
												let text = `Cổng game uy tín xanh chín nhất Winclup68.com.
												...
												Message.create({'uid': client.UID, 'title':'Thành Viên Mới Winclup68.com', 'text':text, 'time':new Date()});
